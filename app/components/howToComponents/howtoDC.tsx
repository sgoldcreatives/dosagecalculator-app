      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <AlertDialog>
              <AlertDialogTrigger
                className="flex items-center border-2 border-green-500 rounded-md px-3 py-1.5 bg-white text-green-700
              ...
              <AlertDialogContent className="border-4 border-green-500">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="text-md text-slate-900">
                    For basic use,{" "}
                    <strong>
                      input the patient&apos;s weight in the text box
                    </strong>{" "}
                    and search for the medications you need.
                    <Accordion type="single" collapsible>
                      <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                          <strong>Search-box:</strong> Allows you to search for
                          any medication by name.
                          <br />
                      ...
                      <AccordionItem value="item-2">
                        ...
                        <AccordionContent>
                          <div className="flex items-center">
                            <span className="border-2 p-1 rounded-md mr-1 mb-3">
                              <svg
                                width="15"
                                height="15"
                                viewBox="0 0 15 15"
                            ...
                            : Provides dose in written form.
                            <br />
                            (if used without weight input, it will show the
                            formula)
                          </div>
                          <div>
                            <br />
                          ...
                          <div className="flex items-center">
                            ...
                            : Provides information on medication (description,
                            when it is used,etc.).
                          </div>
                        </AccordionContent>
                      </AccordionItem>
